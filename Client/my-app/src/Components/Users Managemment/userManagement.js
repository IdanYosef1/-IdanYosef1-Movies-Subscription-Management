...
function UserManagemnt(){
    ...
    (window.location.pathname === '/addUser') ? colorAddUser = 'AllAddButtons' : colorEditUser = 'AllAddButtons' ;
    
    return <div className="text-center">
        <MainPage />
        <h2 >Users</h2>
        <button className={colorAddUser} onClick={allUsers}>All Users</button>
        <button className={colorEditUser} onClick={addUser}>Add User</button> <br/><br/>
    </div>;
}
