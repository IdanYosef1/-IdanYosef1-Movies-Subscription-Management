...
const urlPerm = "https://cinema-api-2tnd.onrender.com/api/permissions";
...
function Navbar() {
  ...
  const clickSubs = store.permissions.View_Subscriptions
    ? subscriptionsPage
    : null;

  let moviesButton = "inactiveButton",
    subsButton = "inactiveButton",
    userManageButton = "inactiveButton",
    ...
    <div className="text-center">
      <nav className="nav" variant="dark">
        ...
        <nav className="buttons-nav">
          <Nav.Item>
            <button className={moviesButton} onClick={clickMovies}>
              Movies
            </button>
          </Nav.Item>
          <Nav.Item>
            <button className={subsButton} onClick={clickSubs}>
              Subscriptions
            </button>
          </Nav.Item>
          {store.isManager === true ? (
            <Nav.Item>
              <button className={userManageButton} onClick={userManagement}>
                User Management
              </button>
            </Nav.Item>
          ) : null}
          <Nav.Item>
            <button className={logoutButton} onClick={logOut}>
              <MdLogout className="iconLogout" /> Log Out
            </button>
          </Nav.Item>
        </nav>
      </nav>
